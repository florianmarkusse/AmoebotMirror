...
DiscoDemoAlg::DiscoDemoAlg()
    : Algorithm("Demo: Disco", "discodemo")
{
...
MetricsDemoAlg::MetricsDemoAlg()
    : Algorithm("Demo: Metrics", "metricsdemo")
{
    addParameter("# Particles", "30");
    addParameter("Counter Max", "5");
};
...
BallroomDemoAlg::BallroomDemoAlg()
    : Algorithm("Demo: Ballroom", "ballroomdemo")
{
    addParameter("# Particles", "30");
}
...
TokenDemoAlg::TokenDemoAlg()
    : Algorithm("Demo: Token Passing", "tokendemo")
{
...
ShortcutBridgingAlg::ShortcutBridgingAlg()
    : Algorithm("Shortcut Bridging", "shortcutbridging")
{
    addParameter("# Particles", "100");
    addParameter("Lambda", "4.0");
    addParameter("c", "1.5");
